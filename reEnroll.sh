...
function createManufacturer() {
  ...
  set -x
  fabric-ca-client reenroll -u https://admin:adminpw@localhost:7054 --caname ca-manufacturer --tls.certfiles "${PWD}/organizations/fabric-ca/manufacturer/ca-cert.pem" --csr.keyrequest.reusekey
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client reenroll -u https://peer0:peer0pw@localhost:7054 --caname ca-manufacturer -M "${PWD}/organizations/peerOrganizations/manufacturer.auto.com/peers/peer0.manufacturer.auto.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/manufacturer/ca-cert.pem" --csr.keyrequest.reusekey
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client reenroll -u https://user1:user1pw@localhost:7054 --caname ca-manufacturer -M "${PWD}/organizations/peerOrganizations/manufacturer.auto.com/users/User1@manufacturer.auto.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/manufacturer/ca-cert.pem" --csr.keyrequest.reusekey
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client reenroll -u https://manufactureradmin:manufactureradminpw@localhost:7054 --caname ca-manufacturer -M "${PWD}/organizations/peerOrganizations/manufacturer.auto.com/users/Admin@manufacturer.auto.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/manufacturer/ca-cert.pem" --csr.keyrequest.reusekey
  { set +x; } 2>/dev/null
...
function createDealer() {
  ...
  set -x
  fabric-ca-client reenroll -u https://admin:adminpw@localhost:8054 --caname ca-dealer --tls.certfiles "${PWD}/organizations/fabric-ca/dealer/ca-cert.pem" --csr.keyrequest.reusekey
  { set +x; } 2>/dev/null
  ...
  echo "Generating the peer0 msp"
  set -x
  fabric-ca-client reenroll -u https://peer0:peer0pw@localhost:8054 --caname ca-dealer -M "${PWD}/organizations/peerOrganizations/dealer.auto.com/peers/peer0.dealer.auto.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/dealer/ca-cert.pem" --csr.keyrequest.reusekey
  { set +x; } 2>/dev/null
  ...
  echo "Generating the peer0-tls certificates, use --csr.hosts to specify Subject Alternative Names"
  set -x
  fabric-ca-client reenroll -u https://peer0:peer0pw@localhost:8054 --caname ca-dealer -M "${PWD}/organizations/peerOrganizations/dealer.auto.com/peers/peer0.dealer.auto.com/tls" --enrollment.profile tls --csr.hosts peer0.dealer.auto.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/dealer/ca-cert.pem" --csr.keyrequest.reusekey
  { set +x; } 2>/dev/null
  ...
  echo "Generating the user msp"
  set -x
  fabric-ca-client reenroll -u https://user1:user1pw@localhost:8054 --caname ca-dealer -M "${PWD}/organizations/peerOrganizations/dealer.auto.com/users/User1@dealer.auto.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/dealer/ca-cert.pem" --csr.keyrequest.reusekey
  { set +x; } 2>/dev/null
  ...
  echo "Generating the org admin msp"
  set -x
  fabric-ca-client reenroll -u https://dealeradmin:dealeradminpw@localhost:8054 --caname ca-dealer -M "${PWD}/organizations/peerOrganizations/dealer.auto.com/users/Admin@dealer.auto.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/dealer/ca-cert.pem" --csr.keyrequest.reusekey
  { set +x; } 2>/dev/null
...
function createMvd() {
  ...
  set -x
  fabric-ca-client reenroll -u https://admin:adminpw@localhost:11054 --caname ca-mvd --tls.certfiles "${PWD}/organizations/fabric-ca/mvd/ca-cert.pem" --csr.keyrequest.reusekey
  { set +x; } 2>/dev/null
  ...
  echo "Generating the peer0 msp"
  set -x
  fabric-ca-client reenroll -u https://peer0:peer0pw@localhost:11054 --caname ca-mvd -M "${PWD}/organizations/peerOrganizations/mvd.auto.com/peers/peer0.mvd.auto.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/mvd/ca-cert.pem" --csr.keyrequest.reusekey
  { set +x; } 2>/dev/null
  ...
  echo "Generating the peer0-tls certificates, use --csr.hosts to specify Subject Alternative Names"
  set -x
  fabric-ca-client reenroll -u https://peer0:peer0pw@localhost:11054 --caname ca-mvd -M "${PWD}/organizations/peerOrganizations/mvd.auto.com/peers/peer0.mvd.auto.com/tls" --enrollment.profile tls --csr.hosts peer0.mvd.auto.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/mvd/ca-cert.pem" --csr.keyrequest.reusekey
  { set +x; } 2>/dev/null
  ...
  echo "Generating the user msp"
  set -x
  fabric-ca-client reenroll -u https://user1:user1pw@localhost:11054 --caname ca-mvd -M "${PWD}/organizations/peerOrganizations/mvd.auto.com/users/User1@mvd.auto.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/mvd/ca-cert.pem" --csr.keyrequest.reusekey
  { set +x; } 2>/dev/null
  ...
  echo "Generating the org admin msp"
  set -x
  fabric-ca-client reenroll -u https://mvdadmin:mvdadminpw@localhost:11054 --caname ca-mvd -M "${PWD}/organizations/peerOrganizations/mvd.auto.com/users/Admin@mvd.auto.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/mvd/ca-cert.pem" --csr.keyrequest.reusekey
  { set +x; } 2>/dev/null
...
function createOrderer() {
  ...
  set -x
  fabric-ca-client reenroll -u https://orderer:ordererpw@localhost:9054 --caname ca-orderer -M "${PWD}/organizations/ordererOrganizations/auto.com/orderers/orderer.auto.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/ordererOrg/ca-cert.pem" --csr.keyrequest.reusekey
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client reenroll -u https://orderer:ordererpw@localhost:9054 --caname ca-orderer -M "${PWD}/organizations/ordererOrganizations/auto.com/orderers/orderer.auto.com/tls" --enrollment.profile tls --csr.hosts orderer.auto.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/ordererOrg/ca-cert.pem" --csr.keyrequest.reusekey
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client reenroll -u https://ordererAdmin:ordererAdminpw@localhost:9054 --caname ca-orderer -M "${PWD}/organizations/ordererOrganizations/auto.com/users/Admin@auto.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/ordererOrg/ca-cert.pem" --csr.keyrequest.reusekey
  { set +x; } 2>/dev/null
